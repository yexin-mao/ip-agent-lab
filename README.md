...
4. Retrieve prior art from a local sample patent corpus.
5. Compare invention points with retrieved patents.
...
points for external patent APIs, Qdrant, rerankers, and LLM-based agents.
